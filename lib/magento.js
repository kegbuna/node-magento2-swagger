...
var Magento = (function() {
    ...
    function Magento(options) {
        ...
        this.domain = domain ? domain : 'http://10.64.246.214/builds/TEMP-MMFAT-IC/instance-0/rest/default';
     ...
     * @method catalogProductWebsiteLinkRepositoryV1SavePost
     * @name Magento#catalogProductWebsiteLinkRepositoryV1SavePost
     * @param {string} sku - 
     * @param {} $body - 
     *
     */
    Magento.prototype.catalogProductWebsiteLinkRepositoryV1SavePost = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
    ...
    /**
     * Assign a product to the website
     * @method catalogProductWebsiteLinkRepositoryV1SavePut
     * @name Magento#catalogProductWebsiteLinkRepositoryV1SavePut
     * @param {string} sku - 
     * @param {} $body - 
     *
     */
    Magento.prototype.catalogProductWebsiteLinkRepositoryV1SavePut = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
     ...
     * @method catalogProductWebsiteLinkRepositoryV1DeleteByIdDelete
     * @name Magento#catalogProductWebsiteLinkRepositoryV1DeleteByIdDelete
     * @param {string} sku - 
     * @param {integer} websiteId - 
     *
     */
    Magento.prototype.catalogProductWebsiteLinkRepositoryV1DeleteByIdDelete = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
        ...
        path = path.replace('{websiteId}', parameters['websiteId']);
    ...
    Magento.prototype.quoteShippingMethodManagementV1EstimateByAddressPost = function(parameters) {
        ...
        var domain = this.domain;
        var path = '/V1/carts/{cartId}/estimate-shipping-methods';
    ...
    Magento.prototype.quoteShippingMethodManagementV1EstimateByAddressIdPost = function(parameters) {
        ...
        var domain = this.domain;
        var path = '/V1/carts/{cartId}/estimate-shipping-methods-by-address-id';
    ...
    Magento.prototype.quoteCartItemRepositoryV1SavePost = function(parameters) {
        ...
        var domain = this.domain;
        var path = '/V1/carts/{quoteId}/items';
    ...
    Magento.prototype.catalogInventoryStockRegistryV1GetStockItemBySkuGet = function(parameters) {
        ...
        if (parameters['scopeId'] !== undefined) {
            queryParameters['scopeId'] = parameters['scopeId'];
        }
    ...
    Magento.prototype.catalogInventoryStockRegistryV1GetLowStockItemsGet = function(parameters) {
        ...
        if (parameters['scopeId'] === undefined) {
            deferred.reject(new Error('Missing required  parameter: scopeId'));
            return deferred.promise;
        }
     ...
     * @method salesOrderItemRepositoryV1GetGet
     * @name Magento#salesOrderItemRepositoryV1GetGet
     * @param {integer} id - The order item ID.
     *
     */
    Magento.prototype.salesOrderItemRepositoryV1GetGet = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
     ...
     * @method salesOrderItemRepositoryV1GetListGet
     * @name Magento#salesOrderItemRepositoryV1GetListGet
     * @param {string} searchCriteria[filterGroups][][filters][][field] - Field
     * @param {string} searchCriteria[filterGroups][][filters][][value] - Value
     * @param {string} searchCriteria[filterGroups][][filters][][conditionType] - Condition type
     * @param {string} searchCriteria[sortOrders][][field] - Sorting field.
     ...
     *
     */
    Magento.prototype.salesOrderItemRepositoryV1GetListGet = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
    ...
    Magento.prototype.checkoutGuestShippingInformationManagementV1SaveAddressInformationPost = function(parameters) {
        ...
        var domain = this.domain;
        var path = '/V1/guest-carts/{cartId}/shipping-information';
