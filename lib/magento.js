...
var Magento = (function() {
    ...
    function Magento(options) {
        ...
        if (typeof options.token === 'object') {
            if (options.token.headerOrQueryName && options.token.value) {
                if (options.token.headerOrQueryName.isQuery) {
                    // request doesn't seem to support 'defaulting' a query
                } else {
                    var defaultHeaders = {};
                    defaultHeaders[options.token.headerOrQueryName] = options.token.value;
